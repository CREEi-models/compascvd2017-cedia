...
program define cmp_clear
	...
	foreach mat in cmp_mprobit_group_inds cmp_roprobit_group_inds cmp_num_cuts cmpEqs cmp_nonbase_cases cmp_RC_T cmp_trunceqs cmp_intregeqs cmp_NumEff cmpGammaInd cmpBetaInd cmpXVarsAll {
		cap mat drop `mat'
	}
