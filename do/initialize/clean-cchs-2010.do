...
use data/cchs/cchs-2010.dta, clear
...
* recode provinces
recode geogprv (10/13=1) (24=2) (35=3) (46/48=4) (59=5) (else=.), gen(province)
...
*                                                disease (COPD)
rename ccc_091 lunge
recode lunge (2=0) (6=0) (7/9=.)
...
tab adl_01
rename adl_01 iadl_01
recode iadl_01 (2=0) (1=1) (7/9=.)
label values iadl_01 yesno
tab iadl_01

tab adl_02
rename adl_02 iadl_02
recode iadl_02 (2=0) (1=1) (7/9=.)
label values iadl_02 yesno
tab iadl_02

tab adl_03
rename adl_03 iadl_03
recode iadl_03 (2=0) (1=1) (7/9=.)
label values iadl_03 yesno
tab iadl_03

tab adl_04
rename adl_04 adl_01
recode adl_01 (2=0) (1=1) (7/9=.)
label values adl_01 yesno
tab adl_01

tab adl_05
rename adl_05 adl_02
recode adl_02 (2=0) (1=1) (7/9=.)
label values adl_02 yesno
tab adl_02, m


egen iadl = anycount(iadl_01-iadl_03) if doadl==1, values(1)
recode iadl (0=0) (1/max=1)
...
egen adl = anycount(adl_01-adl_02) if doadl==1, values(1)
recode adl (0=0) (1/max=1)
...
#d ;
mlogit income sex ageg imm province educ4
dhhgms dhhghsz dhhglvg gen_08 swl_02 swl_04 lop_015 dhh_own fsc_010 incg2
[fweight = wgt];
#d cr
...
save temp/clean-cchs-2010.dta, replace
